...
var FullCalendar = (function (e) {
  ...
  function os(e) {
    ...
    const nodeList = document.querySelectorAll(".Corpus");
    for (let i = 0; i < nodeList.length; i++) {
    nodeList[i].style.backgroundColor = "#2885ce";
    };

    const nodeList2 = document.querySelectorAll(".Ascención");
    for (let i = 0; i < nodeList2.length; i++) {
    nodeList2[i].style.backgroundColor = "#d36169";
    };

    const nodeList3 = document.querySelectorAll(".Pedro");
