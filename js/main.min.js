...
var FullCalendar = (function (e) {
  ...
  var Lr = (function () {
    ...
    Wr = {
      ...
      allDayText: "all-day",
      moreLinkText: "more",
      noEventsText: "No hay eventos para esta fecha",
    },
    Vr = r(r({}, Wr), {
      buttonHints: {
        prev: "Previous $0",
  ...
  (Go.prototype.classes = {
    ...
    button: "fc-button fc-button-primary col",
  ...
  function os(e) {
    ...
    const nodeList = document.querySelectorAll(".metaverso, .Pedagogía ");
    for (let i = 0; i < nodeList.length; i++) {
    nodeList[i].style.backgroundColor = "#2885ce";
    nodeList[i].style.borderRadius = "5px";
    nodeList[i].style.color = "black";

    };

    const nodeList2 = document.querySelectorAll(".Derechos, .bibliográfica ");
    for (let i = 0; i < nodeList2.length; i++) {
    nodeList2[i].style.backgroundColor = "#80b533";
    nodeList2[i].style.borderRadius = "5px";
    nodeList2[i].style.color = "black";

    };

    const nodeList3 = document.querySelectorAll(".Creatividad, .Producción , .Herramientas  ");
    for (let i = 0; i < nodeList3.length; i++) {
    nodeList3[i].style.backgroundColor = "#e2b533";
    nodeList3[i].style.borderRadius = "5px";
    nodeList3[i].style.color = "black";
    };

    const nodeList4 = document.querySelectorAll(".Seguridad");
    for (let i = 0; i < nodeList3.length; i++) {
    nodeList4[i].style.backgroundColor = "#d36169";
    nodeList4[i].style.borderRadius = "5px";
    nodeList4[i].style.color = "black";
    };
    ...
    return _o(
      ...
      e.timeText && _o(
        "div", 
        { className: "fc-event-time"}, e.timeText),
      _o(
        "a",
        { className: "fc-event-title-container"},
        _o(
          "a",
          { className: "fc-event-title fc-sticky " + e.event.title},
  ...
  function ll(e) {
    return _o(
      ...
      _o(
        "div",
        { className: "fc-event-title "+e.event.title },
        e.event.title || _o(xo, null, " ")
      )
    );
  }
